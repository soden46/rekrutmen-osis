...
<div class="d-flex justify-content-between mb-3">
    <div>
        <form action="{{ route('pembina.hasil') }}" method="GET" class="d-flex">
    ...
    <div>
        <a class="btn btn-md btn-success mr-2" href="{{ route('pembina.hasil.create') }}"><i class="fa fa-plus"></i> Tambah Data</a>
        <a class="btn btn-md btn-success" href="{{ route('pembina.hasil.cetak') }}" target="_blank"><i class="fa fa-print"></i> Cetak PDF</a>
    </div>
</div>
    ...
    <tr>
        ...
        <td>
            <div class="btn-group" style="width:135px">
                <form action="{{ route('pembina.hasil.destroy',$data->id_hasil) }}" method="Post">
                    <a class="btn btn-primary" href="{{ route('pembina.hasil.edit',$data->id_hasil) }}">Edit</a>
                    @csrf
                    @method('DELETE')
