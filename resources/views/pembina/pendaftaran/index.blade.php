...
<div class="d-flex justify-content-between mb-3">
    ...
    <div>
        <a class="btn btn-md btn-success mr-2" href="{{ route('pembina.pendaftaran.create') }}"><i class="fa fa-plus"></i> Tambah Data</a>
        <a class="btn btn-md btn-success" href="{{ route('pembina.pendaftaran.cetak') }}" target="_blank"><i class="fa fa-print"></i> Cetak PDF</a>
    </div>
</div>
        ...
        <td>
            <div class="btn-group" style="width:135px">
                <form action="{{ route('pembina.pendaftaran.destroy',$data->id_pendaftaran) }}" method="Post">
                    <a class="btn btn-primary" href="{{ route('pembina.pendaftaran.edit',$data->id_pendaftaran) }}">Edit</a>
                    @csrf
                    @method('DELETE')
