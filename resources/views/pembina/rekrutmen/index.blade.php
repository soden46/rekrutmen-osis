...
<div class="d-flex justify-content-between mb-3">
    <div>
        <form action="{{ route('pembina.rekrutmen') }}" method="GET" class="d-flex">
    ...
    <div>
        <a class="btn btn-md btn-success mr-2" href="{{ route('pembina.rekrutmen.create') }}"><i class="fa fa-plus"></i> Tambah Data</a>
        <a class="btn btn-md btn-success" href="{{ route('pembina.rekrutmen.cetak') }}" target="_blank"><i class="fa fa-print"></i> Cetak PDF</a>
    </div>
</div>
    ...
    <tr>
        ...
        <td>
            <div class="btn-group" style="width:135px">
                <form action="{{ route('pembina.rekrutmen.destroy', $data->id_rekrutmen) }}" method="Post">
                    <a class="btn btn-primary" href="{{ route('pembina.rekrutmen.edit', $data->id_rekrutmen) }}">Edit</a>
                    @csrf
                    @method('DELETE')
