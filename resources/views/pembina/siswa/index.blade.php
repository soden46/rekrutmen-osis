...
<div class="d-flex justify-content-between mb-3">
    <div>
        <form action="{{ route('pembina.siswa') }}" method="GET" class="d-flex">
    ...
    <div>
        <a class="btn btn-md btn-success" href="{{ route('pembina.siswa.cetak') }}" target="_blank"><i class="fa fa-print"></i> Cetak PDF</a>
    </div>
</div>
    ...
    <tr>
        ...
        <td>
            <div class="btn-group" style="width:135px">
                <form action="{{ route('pembina.siswa.destroy',$data->id_siswa) }}" method="Post">
                    <a class="btn btn-primary" href="{{ route('pembina.siswa.edit',$data->id_siswa) }}">Edit</a>
                    @csrf
                    @method('DELETE')
