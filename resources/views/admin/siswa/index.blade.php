...
@section('content')
    ...
    <div class="d-flex justify-content-between mb-3">
        ...
        <div>
            <a class="btn btn-md btn-success" href="{{ route('admin.siswa.cetak') }}" target="_blank"><i
                    class="fa fa-print"></i> Cetak PDF</a>
            <a class="btn btn-md btn-success" href="{{ route('admin.siswa.create') }}" target="_blank"><i
                    class="fa fa-plus"></i> Buat Akun</a>
        </div>
    </div>
