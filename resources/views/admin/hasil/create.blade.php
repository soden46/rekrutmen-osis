...
@section('content')
    ...
    <div class="col-lg-8">
        <div class="card">
            ...
            <div class="card-body">
                <form method="post" action="{{ route('admin.hasil.save') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="id_pendaftaran" name="id_pendaftaran">
                            ...
                            @foreach ($pendaftaran as $pendaftaran)
                                <option value="{{ $pendaftaran->id_pendaftaran }}">{{ $pendaftaran->id_pendaftaran }} |
                                    {{ $pendaftaran->siswa->users->nama ?? '' }} | {{ $pendaftaran->tanggal ?? '' }}
                                </option>
                            @endforeach
                        </select>
                    </div>
