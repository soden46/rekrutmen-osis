...
@section('content')
    ...
    <div class="d-flex justify-content-between mb-3">
        ...
        <div>
            <a class="btn btn-md btn-success mr-2" href="{{ route('admin.ekskul.create') }}"><i class="fa fa-plus"></i>
                Tambah Data</a>
            <a class="btn btn-md btn-success" href="{{ route('admin.ekskul.cetak') }}" target="_blank"><i
