    ...
    <div class="col-lg-8">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Tambah Pendaftaran Tonti</h5>
            </div>
            <div class="card-body">
                <form method="post" action="{{ route('admin.pendaftaran.tonti.save') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="nilai_seleksi_latihan_tonti"
                            name="nilai_seleksi_latihan_tonti">
                    </div>
                    <div class="form-group">
