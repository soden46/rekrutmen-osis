...
@section('content')
    ...
    <div class="d-flex justify-content-between mb-3">
        <div>
            <form action="{{ route('admin.pendaftaran.tonti') }}" method="GET" class="d-flex">
        ...
        <div>
            <a class="btn btn-md btn-success mr-2" href="{{ route('admin.pendaftaran.tonti.create') }}"><i
                    class="fa fa-plus"></i>
                Tambah Data</a>
            <a class="btn btn-md btn-success" href="{{ route('admin.pendaftaran.tonti.cetak') }}" target="_blank"><i
            ...
            <tr>
                ...
                <td>
                    <div class="btn-group" style="width:135px">
                        <form action="{{ route('admin.pendaftaran.tonti.destroy', $data->id_pendaftaran) }}"
                            method="Post">
                            <a class="btn btn-primary"
                                href="{{ route('admin.pendaftaran.tonti.edit', $data->id_pendaftaran) }}">Edit</a>
                            @csrf
                            @method('DELETE')
